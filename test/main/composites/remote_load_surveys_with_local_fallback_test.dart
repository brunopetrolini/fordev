...
import 'package:for_dev/domain/entities/survey_entity.dart';
import 'package:for_dev/domain/usecases/load_surveys.dart';
...
void main() {
  ...
  test('Should call local fetch in remote error', () async {
